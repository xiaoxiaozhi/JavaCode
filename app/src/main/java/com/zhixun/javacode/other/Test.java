...
public class Test {
    ...
    public static void change() {
        System.out.println("0x02二进制 " + Integer.toBinaryString(0x02));
        System.out.println("4399二进制  " + Integer.toBinaryString(4399));
        int i = 4399;
        //第二位变 0
        if (((4399 >> 1) & 0x01) == 1) {
            System.out.println("第二位变 0 得到" + (4399 ^ 0x02) + " 二进制 " + Integer.toBinaryString((4399 ^ 0x02)));
        }
        //第三位变 1
        System.out.println("第三位变1 得到" + (4399 | 0x01 << 4) + " 二进制 " + Integer.toBinaryString(((4399 | 0x01 << 4))));
    }
}
